...
function toDb(resource: MasterResource, values: Record<string, unknown>, businessId: string) {
  ...
  if (resource === "product") {
    return {
      ...
      industry_item_type: values.industryItemType,
      ...
      minimum_order_qty: values.minimumOrderQty,
      lead_time_days: values.leadTimeDays,
      production_lead_time_days: values.productionLeadTimeDays,
      make_or_buy: values.makeOrBuy,
