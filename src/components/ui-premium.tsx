...
export function Toast({
  ...
  return (
    <div className={cn("rounded-xl border p-4 shadow-lg", typeClasses)}>
      <div className="flex items-start gap-3">
        <span className={cn("flex size-6 items-center justify-center rounded-full text-sm font-bold", iconClasses)}>
          {icons[type]}
        </span>
