...
export function TransaksiWorkspace({ initialWorkspace }: { initialWorkspace: ErpWorkspace }) {
  ...
  const [showNewInvoiceModal, setShowNewInvoiceModal] = useState(() => requestedAction === "new");
                ...
                filteredInvoices.map((invoice) => {
                  ...
                  return (
                    <tr key={invoice.id} className="hover:bg-gray-50">
                      <td data-mobile-label="Invoice" className="px-4 py-3">
                        <p className="font-semibold text-gray-900">{invoice.invoiceNo}</p>
                      </td>
                      <td data-mobile-label="Pelanggan" className="px-4 py-3">
                      ...
                      <td data-mobile-label="Sisa" className={`px-4 py-3 text-right font-semibold ${sisaBayar > 0 ? "text-amber-600" : "text-emerald-600"}`}>
                        {money(sisaBayar)}
                      </td>
